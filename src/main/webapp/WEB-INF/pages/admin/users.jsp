...
<body>
<div class="container">
    <h1>SpringMVC</h1> | <a href="/logout">logout</a>
    <hr/>


    <h3>Users: <a href="/admin/users/add" type="button" class="btn btn-primary btn-sm">ADD</a></h3>
        ...
        <table class="table table-bordered table-striped">
            ...
            <c:forEach items="${userList}" var="user">
                <tr>
                    ...
                    <td>${user.password}</td>
                    <td>
                        <a href="/admin/users/show/${user.id}" type="button" class="btn btn-sm btn-success">View</a>
                        <a href="/admin/users/update/${user.id}" type="button" class="btn btn-sm btn-warning">Update</a>
